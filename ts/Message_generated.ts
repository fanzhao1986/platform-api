...
import * as NS5159812363715302092 from "./FeedRequestAccept_generated";
export namespace reactivemarkets.papi { 
export import FeedRequestAccept = NS5159812363715302092.reactivemarkets.papi.FeedRequestAccept;
}
...
export function unionToBody(
  type: Body,
  accessor: (obj:reactivemarkets.papi.FeedRequest|reactivemarkets.papi.FeedRequestAccept|reactivemarkets.papi.FeedRequestReject|reactivemarkets.papi.MDSnapshotL2|reactivemarkets.papi.PublicTrade|reactivemarkets.papi.SessionStatus) => reactivemarkets.papi.FeedRequest|reactivemarkets.papi.FeedRequestAccept|reactivemarkets.papi.FeedRequestReject|reactivemarkets.papi.MDSnapshotL2|reactivemarkets.papi.PublicTrade|reactivemarkets.papi.SessionStatus|null
): reactivemarkets.papi.FeedRequest|reactivemarkets.papi.FeedRequestAccept|reactivemarkets.papi.FeedRequestReject|reactivemarkets.papi.MDSnapshotL2|reactivemarkets.papi.PublicTrade|reactivemarkets.papi.SessionStatus|null {
  switch(reactivemarkets.papi.Body[type]) {
    ...
    case 'FeedRequestAccept': return accessor(new reactivemarkets.papi.FeedRequestAccept())! as reactivemarkets.papi.FeedRequestAccept;
...
export function unionListToBody(
  type: Body, 
  accessor: (index: number, obj:reactivemarkets.papi.FeedRequest|reactivemarkets.papi.FeedRequestAccept|reactivemarkets.papi.FeedRequestReject|reactivemarkets.papi.MDSnapshotL2|reactivemarkets.papi.PublicTrade|reactivemarkets.papi.SessionStatus) => reactivemarkets.papi.FeedRequest|reactivemarkets.papi.FeedRequestAccept|reactivemarkets.papi.FeedRequestReject|reactivemarkets.papi.MDSnapshotL2|reactivemarkets.papi.PublicTrade|reactivemarkets.papi.SessionStatus|null, 
  index: number
): reactivemarkets.papi.FeedRequest|reactivemarkets.papi.FeedRequestAccept|reactivemarkets.papi.FeedRequestReject|reactivemarkets.papi.MDSnapshotL2|reactivemarkets.papi.PublicTrade|reactivemarkets.papi.SessionStatus|null {
  switch(reactivemarkets.papi.Body[type]) {
    case 'NONE': return null; 
    case 'FeedRequest': return accessor(index, new reactivemarkets.papi.FeedRequest())! as reactivemarkets.papi.FeedRequest;
    case 'FeedRequestAccept': return accessor(index, new reactivemarkets.papi.FeedRequestAccept())! as reactivemarkets.papi.FeedRequestAccept;
...
static create(builder:flatbuffers.Builder, tts:flatbuffers.Long, bodyType:reactivemarkets.papi.Body, bodyOffset:flatbuffers.Offset):flatbuffers.Offset {
