...
public struct SessionStatus : IFlatbufferObject
{
  ...
  public static Offset<reactivemarkets.papi.SessionStatus> CreateSessionStatus(FlatBufferBuilder builder,
      long source_ts = 0,
  ...
  public static Offset<reactivemarkets.papi.SessionStatus> EndSessionStatus(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<reactivemarkets.papi.SessionStatus>(o);
  }
};
