...
public struct FeedRequest : IFlatbufferObject
{
  ...
  public reactivemarkets.papi.SubReqType SubReqType { get { int o = __p.__offset(6); return o != 0 ? (reactivemarkets.papi.SubReqType)__p.bb.GetSbyte(o + __p.bb_pos) : reactivemarkets.papi.SubReqType.Subscribe; } }
  public reactivemarkets.papi.FeedType FeedType { get { int o = __p.__offset(8); return o != 0 ? (reactivemarkets.papi.FeedType)__p.bb.GetShort(o + __p.bb_pos) : reactivemarkets.papi.FeedType.Default; } }
  ...
  public static Offset<reactivemarkets.papi.FeedRequest> CreateFeedRequest(FlatBufferBuilder builder,
  ...
  public static void AddSubReqType(FlatBufferBuilder builder, reactivemarkets.papi.SubReqType subReqType) { builder.AddSbyte(1, (sbyte)subReqType, 1); }
  public static void AddFeedType(FlatBufferBuilder builder, reactivemarkets.papi.FeedType feedType) { builder.AddShort(2, (short)feedType, 0); }
  ...
  public static Offset<reactivemarkets.papi.FeedRequest> EndFeedRequest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<reactivemarkets.papi.FeedRequest>(o);
  }
};
