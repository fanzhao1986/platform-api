...
public struct FeedRequestAccept : IFlatbufferObject
{
  ...
  public static Offset<reactivemarkets.papi.FeedRequestAccept> CreateFeedRequestAccept(FlatBufferBuilder builder,
  ...
  public static Offset<reactivemarkets.papi.FeedRequestAccept> EndFeedRequestAccept(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<reactivemarkets.papi.FeedRequestAccept>(o);
  }
};
