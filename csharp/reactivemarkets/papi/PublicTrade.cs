...
public struct PublicTrade : IFlatbufferObject
{
  ...
  public reactivemarkets.papi.Side Side { get { int o = __p.__offset(16); return o != 0 ? (reactivemarkets.papi.Side)__p.bb.GetSbyte(o + __p.bb_pos) : reactivemarkets.papi.Side.None; } }
  ...
  public static Offset<reactivemarkets.papi.PublicTrade> CreatePublicTrade(FlatBufferBuilder builder,
      long source_ts = 0,
  ...
  public static void AddSide(FlatBufferBuilder builder, reactivemarkets.papi.Side side) { builder.AddSbyte(6, (sbyte)side, 0); }
  ...
  public static Offset<reactivemarkets.papi.PublicTrade> EndPublicTrade(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    builder.Required(o, 8);  // market
    return new Offset<reactivemarkets.papi.PublicTrade>(o);
  }
};
